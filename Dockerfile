...
#   This required Avoiding the precompiled native sqlite gem (see https://github.com/sparklemotion/sqlite3-ruby/issues/434)
...
# 
# gem install sqlite3 -v 1.7.2 --platform=ruby
